...
class Map(ipyleaflet.Map):
    ...
    def add_image(self, url, bounds, name="image", **kwargs):
        ...
        layer = ipyleaflet.ImageOverlay(
            url=url, bounds=bounds, name=name, **kwargs)
        self.add(layer)
    ...
    def add_zoom_slider(
        ...
        control = ipyleaflet.WidgetControl(
            widget=zoom_slider, position=position)
        self.add(control)
    ...
    def add_opacity_slider(
        ...
        control = ipyleaflet.WidgetControl(
            widget=opacity_slider, position=position)
        self.add(control)
    ...
    def add_basemap_gui(self, basemaps=None, position="topright"):
        ...
        control = ipyleaflet.WidgetControl(
            widget=basemap_selector, position=position)
        self.add(control)
    ...
    def add_toolbar(self, position="topright"):
        ...
        def toolbar_click(change):
            if change["new"]:
                toolbar.children = [widgets.HBox(
                    [close_button, toolbar_button]), grid]
            else:
